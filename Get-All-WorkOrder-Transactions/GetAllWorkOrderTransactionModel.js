...
async function getAllWorkOrderTransactions(userPK,tableName) {
  ...
  try {
    ...
    console.log("Unable to fetch WorkOrders", err);
...
module.exports = { getAllWorkOrderTransactions };
