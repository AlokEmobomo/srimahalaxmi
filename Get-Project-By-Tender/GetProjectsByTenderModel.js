...
async function getAllProjectsByTender(tenderId, userPK, tableName) {

  const indexName = "GSI_SK";
  const partitionKey = "SK";
  const sortKey = "userPK";
  console.log(tenderId, userPK);
  ...
  const params = {
    ...
    KeyConditionExpression: "SK = :sk and userPK = :userpk", // Query by both SK and userPK
    FilterExpression: "EntityType = :entityType", // Filter for items where entityType is 'project'
    ExpressionAttributeValues: {
      ":sk": tenderId, // The value for SK (e.g., projectId)
      ":userpk": userPK, // The value for userPK
      ":entityType": "Project", // Only return items where entityType is 'project'
    },
  };
    ...
    console.error("Unable to get details by SK, userPK, and entityType", err);
...
module.exports = { getAllProjectsByTender };
