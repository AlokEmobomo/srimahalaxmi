...
async function getLineItemsByTender(tenderId, userPK, tableName) {
  ...
  const params = {
    ...
    ExpressionAttributeValues: {
      ":sk": tenderId, // The value for SK (e.g., tenderId)
      ":userpk": userPK, // The value for userPK
      ":pkPrefix": `${tenderId}#L`, // The prefix for PK
    },
  };
...
module.exports = { getLineItemsByTender };
