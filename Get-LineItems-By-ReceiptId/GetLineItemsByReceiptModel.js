const { DynamoDBClient, DescribeTableCommand, UpdateTableCommand
...
async function getLineItemsByReceipt(receiptId, userPK, tableName) {
  ...
  const params = {
    ...
    ExpressionAttributeValues: {
      ":sk": receiptId, // The value for SK (e.g., reciptId)
      ":userpk": userPK, // The value for userPK
      ":pkPrefix": `${receiptId}#L`, // The prefix for PK
    },
  };
...
module.exports = { getLineItemsByReceipt };
